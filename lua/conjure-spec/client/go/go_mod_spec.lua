-- [nfnl] fnl/conjure-spec/client/go/go_mod_spec.fnl
local _local_1_ = require("plenary.busted")
local describe = _local_1_["describe"]
local it = _local_1_["it"]
local assert = require("luassert.assert")
local go_mod = require("conjure.client.go.go_mod")
local function _2_()
  local function _3_()
    return assert.equal(0, #go_mod["to-import-replacements-map"](""))
  end
  it("import-replacements-map returns empty table with empty string", _3_)
  local function _4_()
    return assert.equal(0, #go_mod["to-import-replacements-map"]("require require hello test module"))
  end
  it("import-replacements-map with invalid input returns empty structure", _4_)
  local function _5_()
    local actual = go_mod["to-import-replacements-map"]("module github.com/user/module\n\ngo 1.25\n\nrequire (\n\9go.opentelemetry.io/otel/trace v1.38.0\n\9golang.org/x/crypto v0.42.0\n)")
